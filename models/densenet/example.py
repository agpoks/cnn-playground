"""Train a small DenseNet-BC on real CIFAR-10.

    python models/densenet/example.py --device auto --epochs 20

See model.py for the dense-connectivity architecture and papers/README.md
for the reference.
"""
...
from model import DenseNetModel  # noqa: E402
...
def main() -> None:
    ...
    print(f"RESULT: model=densenet metric_name=test_acc metric={final_acc:.4f} params={n_params} train_time_s={train_time:.2f}")
